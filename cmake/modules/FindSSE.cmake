...
### Includes
# TODO: figure out why check_c_source_runs is failing on C17
#include(CheckCSourceRuns)
include(CheckCXXSourceRuns)

### Check
if (ENABLE_SSE)
  # Check compiler for SSE4_2 intrinsics
  if (CMAKE_COMPILER_IS_GNUCC OR (CMAKE_C_COMPILER_ID MATCHES "Clang") OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang") OR (CMAKE_CXX_COMPILER_ID MATCHES "IntelLLVM"))
  ...
  if (ENABLE_AVX512)
    # Check compiler for AVX intrinsics
    if (CMAKE_COMPILER_IS_GNUCC OR (CMAKE_C_COMPILER_ID MATCHES "Clang") OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang") OR (CMAKE_CXX_COMPILER_ID MATCHES "IntelLLVM"))
      set(CMAKE_REQUIRED_FLAGS "-mavx512f -mavx512vl -mavx512cd -mavx512bw -mavx512dq -DLV_HAVE_AVX512")
      check_cxx_source_runs("
        #include <immintrin.h>
        int main() {
          __m512i a, b, c;
